/* master_sintax.java */
/* Generated By:JavaCC: Do not edit this line. master_sintax.java */
package gramatica.archivo_maestro;
import ArbolAST.Nodo;
import javax.swing.JOptionPane;


public class master_sintax implements master_sintaxConstants {
...
{if ("" != null) return raiz;}
  ...
  final public Nodo Master() throws ParseException {Nodo raiz;Token a,b;
    jj_consume_token(DB);
...
raiz = new Nodo("DB",a.beginLine,a.beginColumn,a.image,b.image);
  ...
  public master_sintaxTokenManager token_source;
  ...
  public master_sintax(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public master_sintax(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new master_sintaxTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public master_sintax(java.io.Reader stream) {
  ...
  public master_sintax(master_sintaxTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(master_sintaxTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
