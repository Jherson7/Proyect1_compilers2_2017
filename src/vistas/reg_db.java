 ...
 * @author Jherson Sazo
 */
public class reg_db extends javax.swing.JFrame {

    /**
     * Creates new form registro_db
     */
    public reg_db() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registro_db.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
